      ...
      <div className="flex-1 ml-16 lg:ml-64">
        ...
        <main className="p-6 space-y-6">
          ...
          <motion.div
            ...
            className="max-w-lg rounded-xl border border-[var(--card-border)] bg-[var(--card)] p-6"
          >
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-lg bg-[var(--background)] border border-[var(--card-border)] text-sm outline-none focus:border-[var(--accent)] transition-colors"
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-lg bg-[var(--background)] border border-[var(--card-border)] text-sm outline-none focus:border-[var(--accent)] transition-colors font-mono"
                  placeholder="opk_..."
                />
